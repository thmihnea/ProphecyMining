...
public class CommandAdd extends AbstractCommand {
    ...
    public CommandAdd(CommandSender commandSender, String[] args) {
        super(commandSender, args, "coins.add");
    }
    ...
    public void execute() {
        ...
        final int finalCoins = amount + existing;
        sqlUtil.setValue(TableType.PLAYER_COINS, "COINS", uniqueId, finalCoins);
        String message = Settings.LANG_ADD_COINS;
