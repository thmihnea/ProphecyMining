...
public abstract class AbstractPlugin extends JavaPlugin {
     ...
     */
    private static File config = new File("plugins/ProphecyMining/config.yml");
    ...
    protected final void setupFiles() {
        ...
        try {
            ...
            e.printStackTrace();
            logSevere("An error has occurred while trying to setup the plugin config. Please report this stacktrace to StellarDev!");
        }
    }
