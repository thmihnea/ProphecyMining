...
public class RegionBlock {
    ...
    public static void computeNextBlockType(Block block, Material beforeType) {
        ...
        if (beforeType == Material.STONE && type.equalsIgnoreCase("stone")) {
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(ProphecyMining.getInstance(), () -> block.setType(Material.STONE), 40L);
        }
            ...
            Bukkit.getScheduler().scheduleSyncDelayedTask(ProphecyMining.getInstance(), () -> block.setType(material), 40L);
        }
    }
